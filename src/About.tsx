...
function About({ darkMode }: AboutProps) {
  const experiences = [
    ...
    {
      period: "2024",
      role: "Câblages et travaux électriques",
      company: "Missions récentes",
    },
  ];
  ...
  const education = [
    {
      year: "2009-2013",
      title: "CESS + Bâchelier en informatique industrielle",
    },
    { year: "2011-2012", title: "Développeur Java" },
    {
      year: "1996-1998",
      title: "CTSS - Technicien en utilisation de logiciels standards",
    },
  ...
  return (
    ...
    >
      <div className="max-w-6xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
        ...
        <div
          className={`mt-12 rounded-xl shadow-lg p-8 border ${
            darkMode
              ? "bg-slate-800 border-slate-700"
              : "bg-white border-slate-200"
          }`}
